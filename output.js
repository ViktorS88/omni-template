...
{
  mode: 'production',
  context: '/usr/node_app/app',
  devtool: 'source-map',
  output: {
    hashFunction: 'xxhash64',
    path: '/usr/node_app/app/dist/prod',
  ...
  resolve: {
    alias: {
      '@': '/usr/node_app/app/src',
      nd: '/usr/node_app/node_modules',
    ...
    modules: [
      ...
      '/usr/node_app/node_modules/@vue/cli-service/node_modules'
    ]
  },
  resolveLoader: {
    modules: [
      '/usr/node_app/node_modules/@vue/cli-plugin-babel/node_modules',
      'node_modules',
      './../node_modules',
      '/usr/node_app/node_modules',
      '/usr/node_app/node_modules/@vue/cli-service/node_modules'
    ...
    rules: [
      ...
      /* config.module.rule('vue') */
      {
        ...
        use: [
          ...
          {
            loader: '/usr/node_app/node_modules/vue-loader/dist/index.js',
            options: {
              cacheDirectory: '/usr/node_app/app/node_modules/.cache/vue-loader',
              cacheIdentifier: '2afa15ca',
              babelParserPlugins: [
                'jsx',
                'classProperties',
                'decorators-legacy'
        ...
        oneOf: [
          /* config.module.rule('css').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: '/usr/node_app/node_modules/mini-css-extract-plugin/dist/loader.js',
                options: {
                  publicPath: '/'
                }
              },
              ...
              {
                loader: '/usr/node_app/node_modules/css-loader/dist/cjs.js',
                options: {
                  sourceMap: false,
                  importLoaders: 2,
                  modules: {
              ...
              {
                loader: '/usr/node_app/node_modules/postcss-loader/dist/cjs.js',
                options: {
                  sourceMap: false,
                  postcssOptions: {
                    plugins: [
        ...
        oneOf: [
          /* config.module.rule('scss').oneOf('vue-modules') */
          {
            ...
            use: [
              ...
              {
                loader: '/usr/node_app/node_modules/sass-loader/dist/cjs.js',
                options: {
                  sourceMap: false
                }
              }
      ...
      /* config.module.rule('js') */
      {
        ...
        use: [
          ...
          {
            loader: '/usr/node_app/node_modules/thread-loader/dist/cjs.js'
          },
          /* config.module.rule('js').use('babel-loader') */
          {
            loader: '/usr/node_app/node_modules/@vue/cli-plugin-babel/node_modules/babel-loader/lib/index.js',
            options: {
              cacheCompression: false,
              cacheDirectory: '/usr/node_app/app/node_modules/.cache/babel-loader',
              cacheIdentifier: '77f5a26e'
            }
          }
        ]
      }
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin(
      {
        ...
        template: '/usr/node_app/app/public/index.html'
      }
    ),
    /* config.plugin('copy') */
    new CopyPlugin(
      {
        patterns: [
          {
            from: '/usr/node_app/app/public',
            to: '/usr/node_app/app/dist/prod',
            toType: 'dir',
    ...
    /* config.plugin('CssMinimizerPlugin') */
    new CssMinimizerPlugin()
  ],
  entry: {
    app: [
      '/usr/node_app/app/src/main.js',
      '/usr/node_app/app/src/js/exp/exp.js',
      '/usr/node_app/app/src/js/ms/ms.js',
      '/usr/node_app/app/src/js/vs/vs.js'
    ]
  }
}

Total task duration: 1.05s
